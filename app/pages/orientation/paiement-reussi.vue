 ...
 *
 * Les étapes desktop reprennent « Notre méthode en 4 étapes » de
 * l'écran mobile Orientation. En développement, `?preview=1` affiche
...
<template>
  ...
  <div class="hidden shell:block">
    ...
    >
      ...
      <DesktopPaiementReussi :confirmed="confirmed" :failed="failed" variant="orientation" />
    </PageState>
  </div>
</template>
