 ...
 * encore inégale selon le profil — utilisée quand même en dev (voir
 * `docs/directives-backend.md`). `verified` est le contrôle de profil posé à la
 * main par un admin depuis le 2026-09-11 (§4), plus la confirmation d'e-mail.
 * Toujours hors API (mock) : prix.
 */
