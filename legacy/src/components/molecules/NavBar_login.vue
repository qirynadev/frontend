...
const handleRedirectInside = () => router.push("/connexion");
</script>
...
<template>
  ...
  <!-- Mobile navbar -->
  <div
    class="custom_navbar d-flex flex-row align-items-center justify-content-between mobile-nav"
  ...
  >
    ...
    <div class="others ms-5 d-flex justify-content-evenly align-items-center">
      <ButtonGeneral title="Connexion" className="inside_btn" :withIcon="false" iconPosition="left" :iconURL="myIcon" />
    </div>
  </div>
